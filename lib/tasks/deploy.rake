...
task :deploy_staging => ['deploy:set_staging_app', 'deploy:push', 'deploy:migrate', 'deploy:interpret', 'deploy:restart', 'deploy:tag']
task :deploy_production => ['deploy:set_production_app', 'deploy:push', 'deploy:migrate', 'deploy:interpret', 'deploy:restart', 'deploy:tag']
